...
lyr_LidarDEM_1.set('fieldAliases', {'country_code': 'country_code', 'name': 'Country', 'country_code:1': 'country_code:1', 'subdivision': 'subdivision', 'data_name': 'Data name', 'epsg': 'Horizontal CRS', 'datum': 'Vertical CRS', 'resolution': 'Resolution [m]', 'resolution_unit': 'resolution_unit', 'format': 'Format', 'cost_model': 'cost_model', 'download_link': 'Download link', 'product_link': 'Product link', 'license_link': 'License link', 'wcs_link': 'WCSlink', });
